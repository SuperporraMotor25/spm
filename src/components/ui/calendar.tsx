    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-gray-800 hover:bg-gray-800"
        ),
        ...
        day_selected:
          "bg-racing-red text-white hover:bg-racing-red hover:text-white focus:bg-racing-red focus:text-white",
